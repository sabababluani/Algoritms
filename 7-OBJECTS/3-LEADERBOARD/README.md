...
We are given the same object.

Your task is to create a **Leaderboard**.

Store the student IDs sorted by their total scores in the variable:
...
- The student with the highest total score should be at index `0`.
- The student with the lowest total score (the laziest) should be at the last index.
